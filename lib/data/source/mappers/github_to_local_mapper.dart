import 'package:pokego/core/extensions/string.dart';
import 'package:pokego/data/source/github/models/item.dart';

import 'package:pokego/data/source/github/models/pokemon.dart';
import 'package:pokego/data/source/local/models/item.dart';

import 'package:pokego/data/source/local/models/pokemon.dart';
import 'package:pokego/data/source/local/models/pokemon_gender.dart';
import 'package:pokego/data/source/local/models/pokemon_stats.dart';
